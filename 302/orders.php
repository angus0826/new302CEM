...
<link rel="apple-touch-icon-precomposed" href="images/favicon/favicon.png" sizes="32x32">
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/materialize-logo1.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
